...
class Version:
    def __init__(self, version_id: str, project_id: str, metadata: Optional[Dict[str, Any]] = None):
    ...
    def load_recordings(self):
        ...
        for recording_file in recording_files:
            ...
            self.recordings[recording_id] = Recording.load(self.project_id, self.version_id, recording_id)
    ...
    def create_flowchart(self):
        self.starting_steps = [step for step in self.steps.values() if step.previous_step_id is None]
    ...
    def load(cls, project_id, version_id):
        load_path = os.path.join(ALL_PROJECTS_FOLDER, project_id, version_id, "info.json")
