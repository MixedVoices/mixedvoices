...
if __name__ == "__main__":
    ...
    sample_script_2 = """
            ...
            4. user: It's a 2022 Honda.
            5. bot: Thanks for that information. Please hold on while I check our inventory for motor oil for your 2022 Honda. I have good news. We have motor oil in stock. Is there anything else I can assist you with?  
            6. user: No. That's it. Thanks for the good news.
