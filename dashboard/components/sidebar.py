...
from dashboard.api.endpoints import get_projects_endpoint, get_project_versions_endpoint
...
class Sidebar:
    ...
    def _handle_project_creation(self) -> None:
        ...
        if st.button("Create Project"):
            if new_project_name:
                response = self.api_client.post_data(f"projects?name={new_project_name}", {})
